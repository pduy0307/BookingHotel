								...
								<div class="card-body row">
										...
										<div class="col-lg-6 p-t-20"> 
							              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height txt-full-width">
												...
												<select name="ma_ha" id="sample3" class="mdl-textfield__input" placeholder=""
												style="border: 1px solid #A9A9A9 ;border-radius: 5px; padding: 2px; height: 33.2px" value="">
													<option value="" hidden>Chọn mã hình ảnh</option>
													<?php $list_ma_tt = $data["listma_tt"];?>
													<?php foreach($list_ma_tt as $row){                                                                                                                                         
                                               		?>
